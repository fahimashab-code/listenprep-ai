...
export default function ForgotPasswordPage() {
  ...
  return (
    <Card className="p-6 shadow-[0_16px_45px_rgba(23,32,26,0.07)] sm:p-8">
        ...
        >
          <label className="block text-sm font-semibold">
            ...
            <input
              required
              type="email"
              className="mt-1.5 h-11 w-full rounded-lg border bg-white px-3 outline-none focus:border-[#176b3a] focus:ring-3 focus:ring-green-100"
      ...
      <a
        href="/login"
        className="mt-5 block text-center text-sm font-bold text-[#176b3a]"
      >
        Back to sign in
      </a>
    </Card>
