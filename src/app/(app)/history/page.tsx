    ...
    <>
      ...
      <Card className="hidden overflow-hidden md:block">
        <table className="w-full border-collapse text-left text-sm">
          <thead className="bg-[#f4f7f5] text-xs uppercase tracking-wide text-[#69746d]">
            <tr>
        ...
        {historicalAttempts.map((attempt) => (
          <Card key={attempt.id} className="p-5">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 flex items-center gap-2 text-xs text-[#69746d]">
            ...
            <div className="mt-4 flex items-center justify-between border-t pt-4">
              <div className="flex items-center gap-3 text-sm text-[#69746d]">
                <Badge variant="green">~{attempt.estimatedBand.toFixed(1)}</Badge>
